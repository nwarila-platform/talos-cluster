...
# Captured 2026-07-15 BYTE-EXACT from live `sys/policies/acl/vault-admin`
# (owner decision: capture out-of-band, bootstrap-class).
#
...
# commit — could rewrite this policy, a repo compromise could neuter or
# hijack the break-glass identity. Enforced by
