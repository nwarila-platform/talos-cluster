...
| `test-dr-etcd-backup.py` (740) | Hermetic failure, locking, no-clobber, partial cleanup, and write-then-prune fixtures for the in-cluster etcd producer | N/A (tests) | **KEEP** |
