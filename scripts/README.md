...
| `test-dr-etcd-backup.py` (338) | Hermetic failure, locking, no-clobber, partial cleanup, and write-then-prune fixtures for the in-cluster etcd producer | N/A (tests) | **KEEP** |
| `test-talos-drift-readonly.py` (300) | Unit tests for the in-cluster `talos-drift` CronJob | N/A (tests) | **KEEP** |
