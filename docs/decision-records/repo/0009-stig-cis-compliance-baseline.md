...
| Image signature verification (cosign / sigstore) | STIG V-242414 | not configured | Not addressed yet. Requires policy infrastructure (Kyverno / Sigstore policy-controller). Planned for a future cycle. | (none yet) | 2026-08-26 |
